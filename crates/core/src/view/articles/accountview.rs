...
use crate::view::articles::wallabag;
...
impl AccountWindow {
    pub fn new(context: &mut Context) -> AccountWindow {
        ...
        AccountWindow { id, rect, children }
    }
    ...
    fn handle_event(
        ...
        match *evt {
            ...
            Event::Authenticate => {
                ...
                thread::spawn(move || {
                    hub2.send(Event::ArticlesAuth(wallabag::authenticate(
                        server,
                        "Plato".to_string(),
                        username,
                        password,
